...
export const ActorDescription = {
    SPIDER_MAN: "Lorem ipsum dolor sit amet, et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
    BLACK_PANTHER: "Lorem ipsum dolor sitetur adipiscing elit, sed do eiusmod tempor incididunt ut labore eliqua. Ut eni.",
    IRON_MAN: "Lorem ipsum dolor sit a commodo consequat.",
}  

export const ActorImages = {
    SPIDER_MAN: [require('./../assets/images/spider_man/1.png'), require('./../assets/images/spider_man/2.png'), require('./../assets/images/spider_man/3.png')],
    BLACK_PANTHER: [require('./../assets/images/black_panther/1.png'), require('./../assets/images/black_panther/2.png'), require('./../assets/images/black_panther/3.png')],
    IRON_MAN: [require('./../assets/images/iron_man/1.png'), require('./../assets/images/iron_man/2.png'), require('./../assets/images/iron_man/3.png')],
}  
